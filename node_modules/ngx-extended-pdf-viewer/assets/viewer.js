...
class PDFThumbnailView {
  constructor({
    ...
    anchor.href = linkService.getAnchorUrl('javascript:void(0);');
    ...
    /* Customize code to add checkbox front of pages*/
    let checkbox = document.createElement('input');
    checkbox.setAttribute('data-page-number', this.id);
    checkbox.setAttribute('type', 'checkbox');
    checkbox.setAttribute('class', 'thumbnail_checkbox');
